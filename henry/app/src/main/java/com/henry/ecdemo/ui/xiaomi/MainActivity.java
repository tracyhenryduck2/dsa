...
public class MainActivity extends ECSuperActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTopBarView().setTopBarToStatus(1, R.drawable.topbar_back_bt,
                -1, null,
                null,
                getString(R.string.app_xiaomi), null, this);

        String v = CCPAppManager.get("xiaomi");
        ECDevice.reportHuaWeiToken(v);
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        new TimeIntervalDialog(MainActivity.this,
                                new TimeIntervalDialog.TimeIntervalInterface() {
