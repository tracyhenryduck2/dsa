...
public class DivergeView extends View implements Runnable{
    ...
    protected ArrayList<DivergeInfo> mDeadPool = new ArrayList<DivergeInfo>();
...
//    private static final int mAlphaOffset = 50;
    ...
    public void startDiverges(Object obj){
        ...
        if(mDivergeInfos == null){
            mDivergeInfos = new ArrayList<DivergeInfo>(30);
        }

        if(mQueen == null){
            mQueen = Collections.synchronizedList(new ArrayList<Object>(30));
        }
