...
public class QrUtils implements Runnable{
    /**
     * 对网络连接状态进行判断
     *
    ...
    private  static QrUtils sInstance= new QrUtils();
    ...
    public static String postRequest(
        ...
        try {
            ...
            if (statueCode == 200) {
                ...
                GroupService.syncGroup2(GroupId);
    ...
    public static String getUrl(){
        String s = RestServerDefines.SERVER+"/2016-08-15/Application/"+RestServerDefines.APPKER+"/IMPlus/JoinGroup?sig="+getSig();
        return s;
    }
