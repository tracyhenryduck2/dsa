...
import com.henry.ecdemo.common.view.SettingItem;
import com.henry.ecdemo.storage.ContactSqlManager;
import com.henry.ecdemo.storage.GroupMemberSqlManager;
...
import com.henry.ecdemo.ui.mvp.group.GroupQRUI;
...
public class GroupInfoActivity extends ECSuperActivity implements
	...
	public static final String EXTRA_RELOAD = "com.henry.ecdemo_reload";
	public static final String EXTRA_QUEIT = "com.henry.ecdemo_quit";
	...
	private SettingItem group_erweim;
	...
	private void initView() {
		...
		group_erweim = (SettingItem) findViewById(R.id.group_erweim);
		group_erweim.getCheckedTextView().setSingleLine(true);
...
//		}
		...
		group_erweim.setOnClickListener(new OnItemClickListener(
				SettingsActivity.CONFIG_TYPE_GROUP_ERWEIM));
...
//			changeModifyPermission(changePermission);
	...
	private final class OnItemClickListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			if(mType==6){
				Intent intent = new Intent(GroupInfoActivity.this,GroupQRUI.class);
