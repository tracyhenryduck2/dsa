...
public class SettingPersionInfoActivity extends ECSuperActivity implements View.OnClickListener{
    ...
    private void initView(){
        ...
        nicknameEt.setText(ECApplication.nick);
//        nicknameEt.setSelection(nicknameEt.getText().length());
        signInputView.setText(ECApplication.sign);
...
//                            ECApplication.nick = nick
                            ECApplication.nick = nicknameEt.getText().toString();
                            ECApplication.sign = signature;
